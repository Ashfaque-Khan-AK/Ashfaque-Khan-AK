...
I'm a passionate **Full-Stack Developer** who loves building robust web applications, exploring blockchain technologies, and diving into **Machine Learning**.
I enjoy crafting clean UIs with modern frameworks, writing efficient backend APIs, and analyzing data with Python.
Currently diving deeper into **Web3**, **Smart Contracts** with Solidity, and **ML algorithms** with Scikit-learn.

- 🔭 I’m currently working on **MERN stack projects**, **API documentation** with Swagger, and **ML models** with Pandas/Scikit-learn.
- 🌱 I’m currently learning **Advanced Solidity**, **Web3 integration**, and **ML deployment**.
- 👯 I’m looking to collaborate on **Open Source JavaScript/Blockchain/ML projects**.
- 💬 Ask me about **MERN, REST APIs, Postman, Tailwind CSS, C# WinForms, or Machine Learning**.
- 😄 Pronouns: He/Him
